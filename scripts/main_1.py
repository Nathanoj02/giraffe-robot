...
if __name__ == '__main__':
    ...
    # --- Postural task to break redundancy: same length-5 vector ---
    # e.g. “elbow down” posture
    q_postural = np.array([0.0, 0.8, 0.5, 0.0, 0.0])
    ...
    robot.computeAllTerms(q_ik, np.zeros(robot.model.nv))
